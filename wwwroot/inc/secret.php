...
$pdo_dsn = 'mysql:host=172.16.11.95;dbname=racktables';
$db_username = 'rackuser';
$db_password = 'rtGseb69+';
...
# Fingtab configuration plugin
# It consist to connect to the host by the way of SSH
# For that : copy / paste the following configuration
#
$FING_ssh_binary = "/usr/bin/ssh";
$FING_settings = array(
    "172.16.21.0/24" => array(
        "gateway" => "172.16.21.250",
        "user" => "root",
        "sudo" => TRUE,
